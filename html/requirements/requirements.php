...
$requirements = array_merge($requirements, array(
    ...
    array(
        ...
        'memo' => '<a rel="noopener" target="_blank" href="https://php.net/manual/en/book.image.php">GD</a> extension is enabled.'
    ),
    array(
        'name' => 'ImageMagick extension',
        'mandatory' => false,
        'condition' => (extension_loaded('imagick') && !empty(\Imagick::queryFormats())),
        'memo' => '<a rel="noopener" target="_blank" href="https://php.net/manual/en/book.imagick.php">ImageMagick</a> extension is enabled.'
    ),
    array(
